...
func (p portworxCSITranslator) TranslateInTreeInlineVolumeToCSI(volume *v1.Volume, _ string) (*v1.PersistentVolume, error) {
...
func (p portworxCSITranslator) RepairVolumeHandle(volumeHandle, _ string) (string, error) {
